...
for i in range(1, 630):
    ...
    file_path = rf'c:\Users\msalman\Desktop\OSMOSE ETs\Glass\results\Glass\run_003_Parallel_V5_A\s_{i:03}\opt\hc_0000.txt'
...
Output_file = r'C:\Users\msalman\Desktop\OSMOSE ETs\Python work\INDECATE2\data\Results_Parallel_TESTING.csv'
