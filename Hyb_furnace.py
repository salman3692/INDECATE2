...
file_path = r"C:\Users\msalman\Desktop\OSMOSE ETs\Python work\combinations_specific4.csv"  # Replace with the actual file path
...
def display_page(pathname):
    if pathname == '/ng-fired':
        return description_layout("NG-fired Furnace", "NG-fired furnaces use natural gas as the primary fuel source to heat the glass. They are commonly used in the industry due to the relatively low cost and availability of natural gas.")
